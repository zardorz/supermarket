...
public class ProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getArguments() != null && getArguments().getSerializable("ShoppingEntity") != null)
...
//        view.findViewById(R.id.btnNewProduct)
//                .setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View view) {
//                        mHandlerAddProduct.run();
//                    }
//                });
...
//          bestRecyclerView.setLayoutManager(mGrid);
            ...
            ProductAdapter mAdapter = new ProductAdapter(GlobalState.getContext(), featuredProducts);
            ...
            mAdapter.setOnCustomEventListener(new OnCustomEventListener() {
                ...
                public void onEventAll(int value, int position) {
                    ProductEntity productItem = products.getValue().get(position);
                    ...
                    Bundle bundle = new Bundle();
                    if (shopping != null) {
                        fragment = new ProductCartDetailFragment();

                        bundle.putSerializable("ProductEntity", productItem);
                        bundle.putSerializable("ShoppingEntity", shopping);
                    } else {
...
//
//                @Override
//                public void onEvent(int value, int position) {
